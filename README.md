...
*   **Languages:** Java (OOP), JavaScript, HTML, SQL
*   **Frameworks & Databases:** Tailwind CSS, SQLite, Firebase
*   **AI & APIs:** Llama-3.3-70B, Groq LLM, Bright Data SERP, Telegram API
*   **Tools & Platforms:** Git, GitHub, VS Code, Cursor, Cline
...
*   **Zai | Intelligent Warehouse Restock Manager**
    An AI-Agent full-stack system using a Java-based automated safety alerting workflow that isolates impacted storage aisles and pushes structured alerts via the Telegram API[cite: 1].
    *Tech Stack: Java, SQLite, Llama-3.3-70B, Telegram API*
